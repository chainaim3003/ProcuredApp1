  ...
  return (
    <div className="max-w-7xl mx-auto p-6">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Manage your trade instruments and escrowed trades</p>
        {activeAddress && (
      ...
      {/* Seller/Exporter Information Section */}
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <p className="text-sm font-semibold text-gray-900">Jupiter Knitting Company</p>
            </div>
            
            <div>
              <label className="block text-xs font-medium text-gray-500 uppercase mb-1">Legal Entity Identifier (LEI)</label>
              <p className="text-sm font-mono font-semibold text-blue-600">549300ABCDEFGHIJK123</p>
            </div>
            ...
            <div>
              ...
              <p className="text-sm text-gray-900">U17110MH1995PTC088888</p>
            </div>
      ...
      {activeTab === 'my-instruments' ? (
        ...
        <div className="bg-white shadow rounded-lg">
          <div className="px-6 py-4 border-b border-gray-200">
            <h2 className="text-xl font-semibold text-gray-900">My Trade Instruments</h2>
            <p className="text-sm text-gray-500 mt-1">
          ...
          <div className="p-6">
            <div className="text-center py-12">
              ...
              <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4 max-w-md mx-auto">
                <h4 className="text-sm font-semibold text-blue-900 mb-2">💡 How to create instruments:</h4>
        ...
        <div className="bg-white shadow rounded-lg">
          <div className="px-6 py-4 border-b border-gray-200">
            <h2 className="text-xl font-semibold text-gray-900">Escrowed Trades</h2>
            <p className="text-sm text-gray-500 mt-1">
          ...
          <div className="p-6">
            <div className="text-center py-12">
              <div className="text-gray-400 text-lg mb-2">💰</div>
              <h3 className="text-lg font-medium text-gray-900 mb-2">No escrowed trades</h3>
              <p className="text-gray-500 mb-4">
              ...
              <div className="mt-6 bg-green-50 border border-green-200 rounded-lg p-4 max-w-md mx-auto">
                <h4 className="text-sm font-semibold text-green-900 mb-2">✅ Escrow Process:</h4>
                <ol className="text-xs text-green-800 text-left space-y-1">
      ...
      <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white shadow rounded-lg p-6">
          <div className="text-center">
            ...
            <p className="text-sm text-gray-500 mt-1">Active Instruments</p>
          </div>
        </div>
        <div className="bg-white shadow rounded-lg p-6">
          <div className="text-center">
            <p className="text-2xl font-bold text-gray-900">0</p>
            <p className="text-sm text-gray-500 mt-1">Escrowed Trades</p>
          </div>
        </div>
        <div className="bg-white shadow rounded-lg p-6">
          <div className="text-center">
            <p className="text-2xl font-bold text-gray-900">{formatUsd(0)}</p>
      ...
      <div className="mt-8 bg-purple-50 border border-purple-200 rounded-lg p-6">
        <h3 className="text-lg font-semibold text-purple-900 mb-3">📘 Seller Dashboard Features</h3>
